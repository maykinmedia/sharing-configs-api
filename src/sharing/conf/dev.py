...
os.environ.setdefault(
    "SECRET_KEY",
    "django-insecure-hbwcifrcld9wln-m#w#rwscn(@ktf3ot_=sad^nlprhkf9pr*x",
)
os.environ.setdefault("IS_HTTPS", "no")
os.environ.setdefault("VERSION_TAG", "dev")

os.environ.setdefault("DB_NAME", "sharing"),
os.environ.setdefault("DB_USER", "sharing"),
os.environ.setdefault("DB_PASSWORD", "sharing"),
