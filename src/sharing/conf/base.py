...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", "sharing"),
        "USER": config("DB_USER", "sharing"),
        "PASSWORD": config("DB_PASSWORD", "sharing"),
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "sharing.utils.context_processors.settings",
            ],
...
DEFAULT_FROM_EMAIL = "sharing@example.com"
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": os.path.join(LOGGING_DIR, "sharing.log"),
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
...
AUTHENTICATION_BACKENDS = [
    ...
    "sharing.accounts.backends.UserModelEmailBackend",
...
CSRF_FAILURE_VIEW = "sharing.accounts.views.csrf_failure"
...
ADMIN_INDEX_DISPLAY_DROP_DOWN_MENU_CONDITION_FUNCTION = (
    "sharing.utils.django_two_factor_auth.should_display_dropdown_menu"
)
...
ELASTIC_APM = {
    "SERVICE_NAME": f"sharing {ENVIRONMENT}",
